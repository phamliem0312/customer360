 ...
 ************************************************************************/
 ...
 define('customer360:views/customer/record/panel/panel2', ['views/record/panels-container'], function (Dep) {
    return Dep.extend({

        template: 'customer360:customer/record/panel/panel2',

        setup: function () {
            this.recordHelper = this.options.recordHelper;
            this.getCollectionFactory().create('Opportunity', (collection) => {
        ...
        setupPanelViews: function () {
            var p = {
                ...
                "hidden": false,
                "actionsViewKey": "opportunitiesActions",
                "tabNumber": -1,
                "create": true,
                "buttonList": [
                    {
                ...
                "titleHtml": "<span class=\"color-icon fas fa-square-full\" style=\"color: rgb(164, 197, 224);\"></span>&nbsp;Opportunities"
            }
            var name = p.name;
