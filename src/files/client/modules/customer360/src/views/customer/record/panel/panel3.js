 ...
 ************************************************************************/
 ...
 define('customer360:views/customer/record/panel/panel3', ['views/record/panels-container'], function (Dep) {
    return Dep.extend({

        template: 'customer360:customer/record/panel/panel3',

        setup: function () {
            this.recordHelper = this.options.recordHelper;
            this.getCollectionFactory().create('Lead', (collection) => {
        ...
        setupPanelViews: function () {
            var p = {
                ...
                "titleHtml": "<span class=\"color-icon fas fa-square-full\" style=\"color: rgb(164, 197, 224);\"></span>&nbsp;Leads"
            }
            var name = p.name;
